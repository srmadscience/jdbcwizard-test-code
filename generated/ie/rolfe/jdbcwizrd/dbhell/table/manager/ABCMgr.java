...
* <p>
*/ 
public class ABCMgr extends AbstractTableMgr implements OracleResourceUser, StatsInterface 
{ 
  /**                                             
  ...
  * 
  */                                              
  public ABCMgr(Connection theConnection, LogInterface theLog) 
    { 
    super(theConnection, theLog);
    theLog.debug("ABCMgr - Started");
  ...
  /**                                             
  * Validate a ABCRow
  * @param ABCRow theRow The row to be validated
  ...
  * 
  */                                              
  public void rowValidate( ABCRow theRow) throws CSColumnException 
    { 
    theLog.debug("Validating Row");
    // Column row_ can not be more than 1 characters
    if (theRow.row_ != null && theRow.row_.length() > 1 )
      {
      throw new CSColumnException("\"a b c\"","",CSColumnException.COLUMN_LENGTH_EXCEEDED,theRow.row_,true,1,0,"\"a b c\". is too big");
      }
      
    } 
    
/**
* Create a single ABCRow from a com.orindasoft.pub.ReadOnlyRowSet
* @param com.orindasoft.pub.ReadOnlyRowSet theRowSet - A ReadOnlyRowSet that is a row from DBHELL.a b c
* @return ABCRow
**/
public ABCRow processOneABCRow(com.orindasoft.pub.ReadOnlyRowSet theRowSet) throws CSException
  {
  ABCRow new_record = null;

  if (theRowSet.size() > 0)
    {
    new_record = new ABCRow();
    theRowSet.first();
    ...
    if (theArray[0] != null)
      {
      new_record.setRow_((String)theArray[0]);
      }
    }
...
/**
* Create an arbitrary number of ABCRow from a com.orindasoft.pub.ReadOnlyRowSet
* @param com.orindasoft.pub.ReadOnlyRowSet theRowSet
* @return ABCRow[]
**/
public ABCRow[] processManyABCRows(com.orindasoft.pub.ReadOnlyRowSet theRowSet, int howMany) throws CSException
  {
  ...
  */ 
  ...
  public boolean releaseResources() 
    ...
    theLog.debug("ABCMgr - Attempting to release connection");
    try 
      { 
      } 
    catch (Exception e) 
    ...
    theConnection = null; 
    incReleaseCount(); 
    theLog.debug("ABCMgr- Finished releasing connection");
  ...
  */ 
  ...
  public boolean setConnection(Connection theConnection) 
    ...
    theLog.debug("ABCMgr - Attempting to set connection");
    try 
      { 
