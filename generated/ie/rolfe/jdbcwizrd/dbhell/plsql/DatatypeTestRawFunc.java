...
/** 
* DatatypeTestRawFunc - Access Procedure DATATYPE_TEST.RAW_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 09:31:58.469 EST
...
* </pre></code> 
*/ 
public class DatatypeTestRawFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.RAW_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestRawFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestRawFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    functionResult =  (byte[])theParameters.getParam(1);
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    theParameters.setOutParam(1,OracleTypes.VARBINARY);
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.RAW_FUNC( ?); END; "); // 1 0 characters
