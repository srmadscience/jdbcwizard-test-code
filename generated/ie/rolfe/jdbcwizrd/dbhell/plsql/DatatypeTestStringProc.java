...
/** 
* DatatypeTestStringProc - Access Procedure DATATYPE_TEST.STRING_PROC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 09:31:58.714 EST
...
* </pre></code> 
*/ 
public class DatatypeTestStringProc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.STRING_PROC";   
  ...
  * 
  */                                              
  public DatatypeTestStringProc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestStringProc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN DATATYPE_TEST.STRING_PROC(IN_PARAM =>  ?, OUT_PARAM =>  ?, IN_OUT_PARAM =>  ?); END; "); // 1 0 characters
