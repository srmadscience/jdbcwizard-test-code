...
/** 
* DatatypeTestDateProc - Access Procedure DATATYPE_TEST.DATE_PROC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 09:31:57.333 EST
...
* </pre></code> 
*/ 
public class DatatypeTestDateProc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */
  public java.util.Date paramInParam = null;
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.DATE_PROC";   
  ...
  * 
  */                                              
  public DatatypeTestDateProc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestDateProc started");  //DEBUG                  
    }                                                             
   
   
  /**
  * Method to set parameter IN_PARAM
  * @param java.util.Date paramInParam
  */
  public void setParamInParam(java.util.Date paramInParam)
    {
    if (paramInParam == null)
      ...
      {
      this.paramInParam = new java.util.Date(paramInParam.getTime());
      }
    }
  ...
  */
  public void setParamInParam(long paramInParam)
    {
    this.paramInParam = new java.util.Date(paramInParam);
    }
  ...
  * @param java.util.Date paramInOutParam
  */
  public void setParamInOutParam(java.util.Date paramInOutParam)
    {
    if (paramInOutParam == null)
      ...
      {
      this.paramInOutParam = new java.util.Date(paramInOutParam.getTime());
      }
    }
  ...
  */
  public void setParamInOutParam(long paramInOutParam)
    {
    this.paramInOutParam = new java.util.Date(paramInOutParam);
    }
  ...
  */
  public java.util.Date getParamOutParam()
    {
    ...
    return (new java.util.Date(paramOutParam.getTime()));
    }
  ...
  */
  public long getParamOutParamLong()
    {
    return (paramOutParam.getTime());
    }
  /**
  * Method to get OUT_PARAM
  * @return java.sql.Timestamp
  */
  public java.sql.Timestamp getParamOutParamTimestamp()
    {
    if (paramOutParam == null)
      {
      return(null);
    ...
    return (new java.sql.Timestamp(paramOutParam.getTime()));
    }
  ...
  * @return java.util.Date
  */
  public java.util.Date getParamInOutParam()
    {
    if (paramInOutParam == null)
      {
      return(null);
    ...
    return (new java.util.Date(paramInOutParam.getTime()));
    }
  ...
  */
  public long getParamInOutParamLong()
    {
    return (paramInOutParam.getTime());
    }
  /**
  * Method to get IN_OUT_PARAM
  * @return java.sql.Timestamp
  */
  public java.sql.Timestamp getParamInOutParamTimestamp()
    {
    if (paramInOutParam == null)
      {
      return(null);
    ...
    return (new java.sql.Timestamp(paramInOutParam.getTime()));
    }
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    paramOutParam =  (java.util.Date)theParameters.getParam(2);
    
    // Unload parameter IN_OUT_PARAM
    
    // Unload paramInOutParam
    theLog.debug("Unloading parameter paramInOutParam" );
    paramInOutParam =  (java.util.Date)theParameters.getParam(3);
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN DATATYPE_TEST.DATE_PROC(IN_PARAM =>  ?, OUT_PARAM =>  ?, IN_OUT_PARAM =>  ?); END; "); // 1 0 characters
