...
/** 
* DatatypeTestClobFunc - Access Procedure DATATYPE_TEST.CLOB_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 09:31:57.136 EST
...
* </pre></code> 
*/ 
public class DatatypeTestClobFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */
  ...
  /**
  * Variable to store LOB locator for functionResult
  * @see oracle.sql.CLOB
  */
  public oracle.sql.CLOB lobFunctionResult = null;
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.CLOB_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestClobFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestClobFunc started");  //DEBUG                  
    }                                                             
  ...
  */
  ...
  /**
  * Method to set desired filename for functionResult
  * @param String filenameFunctionResult
  */
  ...
  * @throws NullPointerException if _function_result_1 is null
  */
  public oracle.sql.CLOB getFunctionResultClob() 
    {
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    try  
      { 
      lobFunctionResult =  (oracle.sql.CLOB)theParameters.getParam(1);    
      if (lobFunctionResult != null && useByteArraysForLongsAndLOBS)
        { 
        byteArrayFunctionResult = objectLoader.unloadClobIntoCharArray(lobFunctionResult);
        }
      else if (lobFunctionResult != null && (! keepLobs))
        { 
        functionResult = objectLoader.unloadClob(functionResult, lobFunctionResult);   
        }
      }                        
    catch (Exception e)   
      {                                 
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    theParameters.setOutParam(1,OracleTypes.CLOB);
    ...
    try  
      ...
      theParameters.setParam(2,lobInParam);
      }   
    catch (SQLException e)   
      {           
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.CLOB_FUNC( ?); END; "); // 1 0 characters
