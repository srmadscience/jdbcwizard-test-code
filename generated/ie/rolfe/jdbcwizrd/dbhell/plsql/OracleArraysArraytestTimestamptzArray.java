...
/** 
* OracleArraysArraytestTimestamptzArray - Access Procedure ORACLE_ARRAYS.ARRAYTEST_TIMESTAMPTZ_ARRAY
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 09:31:59.723 EST
...
* </pre></code> 
*/ 
public class OracleArraysArraytestTimestamptzArray extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
   
  /**
  * Variable to store P_PARAM1
  */
  public TblVarrayTimestamptz paramPParam1 = null;
   
  /**
  * Variable to store P_PARAM2
  */
  public TblArrayTimestamptz paramPParam2 = null;
   
  /**    
  * The name of the procedure or function we will access.
  * This name be actually refer to a synonym or somebody else's code  
  */                 
  public static final String procName = "ORACLE_ARRAYS.ARRAYTEST_TIMESTAMPTZ_ARRAY";   
  ...
  * 
  */                                              
  public OracleArraysArraytestTimestamptzArray (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("OracleArraysArraytestTimestamptzArray started");  //DEBUG                  
    }                                                             
   
   
  /**
  * Method to set parameter P_PARAM1
  * @param TblVarrayTimestamptz paramPParam1
  */
  public void setParamPParam1(TblVarrayTimestamptz paramPParam1)
    {
  ...
  * @param TblArrayTimestamptz paramPParam2
  */
  public void setParamPParam2(TblArrayTimestamptz paramPParam2)
    {
  ...
  * @return TblVarrayTimestamptz
  */
  public TblVarrayTimestamptz getParamPParam1()
    {
    return(paramPParam1);
    }
  ...
  * @return TblArrayTimestamptz
  */
  public TblArrayTimestamptz getParamPParam2()
    {
    return(paramPParam2);
    }
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    paramPParam1 =  (TblVarrayTimestamptz)theParameters.getParam(3);
    
    // Unload parameter P_PARAM2
    
    // Unload paramPParam2
    theLog.debug("Unloading parameter paramPParam2" );
    paramPParam2 =  (TblArrayTimestamptz)theParameters.getParam(4);
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    if (paramPParam1 == null)
      {  
      paramPParam1 = new TblVarrayTimestamptz(theLog);
      }   
       
    // Make sure P_PARAM2 is not null
    if (paramPParam2 == null)
      {  
      paramPParam2 = new TblArrayTimestamptz(theLog);
      }   
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append("p_param1 TBL_VARRAY_TIMESTAMPTZ := ?; \n"); // 4
      procCall.append("p_param2 TBL_ARRAY_TIMESTAMPTZ := ?; \n"); // 5
      procCall.append("BEGIN  \n"); // 6
      procCall.append(" \n"); // 7
      procCall.append("ORACLE_ARRAYS.ARRAYTEST_TIMESTAMPTZ_ARRAY(p_param1 => p_param1,p_param2 => p_param2); \n"); // 8
      procCall.append("? := p_param1; \n"); // 9
      procCall.append("? := p_param2; \n"); // 10
      procCall.append("END; "); // 11 285 characters
