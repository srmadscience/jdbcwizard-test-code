...
/** 
* DatatypeTestClobProc1 - Access Procedure DATATYPE_TEST.CLOB_PROC_1
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 09:31:57.260 EST
...
* </pre></code> 
*/ 
public class DatatypeTestClobProc1 extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.CLOB_PROC_1";   
  ...
  * 
  */                                              
  public DatatypeTestClobProc1 (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestClobProc1 started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    try  
      { 
      lobOutParam =  (oracle.sql.CLOB)theParameters.getParam(1);    
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN DATATYPE_TEST.CLOB_PROC_1(OUT_PARAM =>  ?, OUT_SEQNO =>  ?); END; "); // 1 0 characters
