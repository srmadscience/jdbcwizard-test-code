...
/** 
* DatatypeTestUrowidProc - Access Procedure DATATYPE_TEST.UROWID_PROC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 09:31:58.752 EST
...
* </pre></code> 
*/ 
public class DatatypeTestUrowidProc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.UROWID_PROC";   
  ...
  * 
  */                                              
  public DatatypeTestUrowidProc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestUrowidProc started");  //DEBUG                  
    }                                                             
  ...
  */
  public void setParamInParam(String paramInParam)
    ...
    if (paramInParam == null)
      ...
      {
      this.paramInParam = new String(paramInParam.getBytes());
      }
    }
  ...
  */
  public void setParamInOutParam(String paramInOutParam)
    ...
    if (paramInOutParam == null)
      ...
      {
      this.paramInOutParam = new String(paramInOutParam.getBytes());
      }
    }
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN DATATYPE_TEST.UROWID_PROC(IN_PARAM =>  ?, OUT_PARAM =>  ?, IN_OUT_PARAM =>  ?); END; "); // 1 0 characters
