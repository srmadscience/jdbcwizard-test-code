...
/** 
* OracleArraysArraytestIymArray - Access Procedure ORACLE_ARRAYS.ARRAYTEST_IYM_ARRAY
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 09:31:59.667 EST
...
* </pre></code> 
*/ 
public class OracleArraysArraytestIymArray extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
   
  /**
  * Variable to store P_PARAM1
  */
  public TblVarrayIym paramPParam1 = null;
   
  /**
  * Variable to store P_PARAM2
  */
  public TblArrayIym paramPParam2 = null;
   
  /**    
  * The name of the procedure or function we will access.
  * This name be actually refer to a synonym or somebody else's code  
  */                 
  public static final String procName = "ORACLE_ARRAYS.ARRAYTEST_IYM_ARRAY";   
  ...
  * 
  */                                              
  public OracleArraysArraytestIymArray (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("OracleArraysArraytestIymArray started");  //DEBUG                  
    }                                                             
   
   
  /**
  * Method to set parameter P_PARAM1
  * @param TblVarrayIym paramPParam1
  */
  public void setParamPParam1(TblVarrayIym paramPParam1)
    {
  ...
  * @param TblArrayIym paramPParam2
  */
  public void setParamPParam2(TblArrayIym paramPParam2)
    {
  ...
  * @return TblVarrayIym
  */
  public TblVarrayIym getParamPParam1()
    {
    return(paramPParam1);
    }
  ...
  * @return TblArrayIym
  */
  public TblArrayIym getParamPParam2()
    {
    return(paramPParam2);
    }
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    paramPParam1 =  (TblVarrayIym)theParameters.getParam(3);
    
    // Unload parameter P_PARAM2
    
    // Unload paramPParam2
    theLog.debug("Unloading parameter paramPParam2" );
    paramPParam2 =  (TblArrayIym)theParameters.getParam(4);
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    if (paramPParam1 == null)
      {  
      paramPParam1 = new TblVarrayIym(theLog);
      }   
       
    // Make sure P_PARAM2 is not null
    if (paramPParam2 == null)
      {  
      paramPParam2 = new TblArrayIym(theLog);
      }   
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append("p_param1 TBL_VARRAY_IYM := ?; \n"); // 4
      procCall.append("p_param2 TBL_ARRAY_IYM := ?; \n"); // 5
      procCall.append("BEGIN  \n"); // 6
      procCall.append(" \n"); // 7
      procCall.append("ORACLE_ARRAYS.ARRAYTEST_IYM_ARRAY(p_param1 => p_param1,p_param2 => p_param2); \n"); // 8
