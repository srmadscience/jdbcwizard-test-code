...
/** 
* DatatypeTestRawProc - Access Procedure DATATYPE_TEST.RAW_PROC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 09:31:58.488 EST
...
* </pre></code> 
*/ 
public class DatatypeTestRawProc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.RAW_PROC";   
  ...
  * 
  */                                              
  public DatatypeTestRawProc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestRawProc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN DATATYPE_TEST.RAW_PROC(IN_PARAM =>  ?, OUT_PARAM =>  ?, IN_OUT_PARAM =>  ?); END; "); // 1 0 characters
