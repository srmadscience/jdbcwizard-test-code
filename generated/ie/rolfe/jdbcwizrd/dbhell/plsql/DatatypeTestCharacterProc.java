...
/** 
* DatatypeTestCharacterProc - Access Procedure DATATYPE_TEST.CHARACTER_PROC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 09:31:57.57 EST
...
* </pre></code> 
*/ 
public class DatatypeTestCharacterProc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.CHARACTER_PROC";   
  ...
  * 
  */                                              
  public DatatypeTestCharacterProc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestCharacterProc started");  //DEBUG                  
    }                                                             
  ...
  * @return String
  */
  public String getParamOutParam()
    {
    ...
    return (new String(paramOutParam.toString()));
    }
  ...
  * @return String
  */
  public String getParamInOutParam()
    {
    ...
    return (new String(paramInOutParam.toString()));
    }
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    theParameters.setOutParam(2,OracleTypes.CHAR);
    ...
    theParameters.setOutParam(3,OracleTypes.CHAR);
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN DATATYPE_TEST.CHARACTER_PROC(IN_PARAM =>  ?, OUT_PARAM =>  ?, IN_OUT_PARAM =>  ?); END; "); // 1 0 characters
