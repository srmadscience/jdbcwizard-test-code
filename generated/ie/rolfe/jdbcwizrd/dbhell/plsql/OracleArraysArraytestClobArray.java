...
/** 
* OracleArraysArraytestClobArray - Access Procedure ORACLE_ARRAYS.ARRAYTEST_CLOB_ARRAY
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 09:31:59.620 EST
...
* </pre></code> 
*/ 
public class OracleArraysArraytestClobArray extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
   
  /**
  * Variable to store P_PARAM1
  */
  public TblVarrayClob paramPParam1 = null;
   
  /**
  * Variable to store P_PARAM2
  */
  public TblArrayClob paramPParam2 = null;
   
  /**    
  * The name of the procedure or function we will access.
  * This name be actually refer to a synonym or somebody else's code  
  */                 
  public static final String procName = "ORACLE_ARRAYS.ARRAYTEST_CLOB_ARRAY";   
  ...
  * 
  */                                              
  public OracleArraysArraytestClobArray (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("OracleArraysArraytestClobArray started");  //DEBUG                  
    }                                                             
   
   
  /**
  * Method to set parameter P_PARAM1
  * @param TblVarrayClob paramPParam1
  */
  public void setParamPParam1(TblVarrayClob paramPParam1)
    {
  ...
  * @param TblArrayClob paramPParam2
  */
  public void setParamPParam2(TblArrayClob paramPParam2)
    {
  ...
  * @return TblVarrayClob
  */
  public TblVarrayClob getParamPParam1()
    {
    return(paramPParam1);
    }
  ...
  * @return TblArrayClob
  */
  public TblArrayClob getParamPParam2()
    {
    return(paramPParam2);
    }
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    paramPParam1 =  (TblVarrayClob)theParameters.getParam(3);
    
    // Unload parameter P_PARAM2
    
    // Unload paramPParam2
    theLog.debug("Unloading parameter paramPParam2" );
    paramPParam2 =  (TblArrayClob)theParameters.getParam(4);
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    if (paramPParam1 == null)
      {  
      paramPParam1 = new TblVarrayClob(theLog);
      }   
       
    // Make sure P_PARAM2 is not null
    if (paramPParam2 == null)
      {  
      paramPParam2 = new TblArrayClob(theLog);
      }   
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append("p_param1 TBL_VARRAY_CLOB := ?; \n"); // 4
      procCall.append("p_param2 TBL_ARRAY_CLOB := ?; \n"); // 5
      procCall.append("BEGIN  \n"); // 6
      procCall.append(" \n"); // 7
      procCall.append("ORACLE_ARRAYS.ARRAYTEST_CLOB_ARRAY(p_param1 => p_param1,p_param2 => p_param2); \n"); // 8
