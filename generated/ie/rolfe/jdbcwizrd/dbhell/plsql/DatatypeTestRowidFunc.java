...
/** 
* DatatypeTestRowidFunc - Access Procedure DATATYPE_TEST.ROWID_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 09:31:58.560 EST
...
* </pre></code> 
*/ 
public class DatatypeTestRowidFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
   
  /**
  * Variable to store result of calling function
  */
  public oracle.sql.ROWID functionResult = null;
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.ROWID_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestRowidFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestRowidFunc started");  //DEBUG                  
    }                                                             
  ...
  */
  public String getFunctionResultString()
    ...
    return (new String(functionResult.getBytes()));
    }
  ...
  */
  public oracle.sql.ROWID getFunctionResultOracleSqlRowid()
    {
    if (functionResult == null)
      {
      return(null);
    ...
    return (new oracle.sql.ROWID(functionResult.getBytes()));
    }
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    functionResult =  (oracle.sql.ROWID)theParameters.getParam(1);
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    theParameters.setOutParam(1,OracleTypes.ROWID);
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.ROWID_FUNC( ?); END; "); // 1 0 characters
