...
/** 
* DatatypeTestBfileProc - Access Procedure DATATYPE_TEST.BFILE_PROC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 09:31:56.761 EST
...
* </pre></code> 
*/ 
public class DatatypeTestBfileProc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */
  public oracle.sql.BFILE lobInParam = null;
  ...
  * @see oracle.sql.BFILE
  */
  public oracle.sql.BFILE lobOutParam = null;
  ...
  * @see oracle.sql.BFILE
  */
  public oracle.sql.BFILE lobInOutParam = null;
  // java.io.File paramInParam not needed in this case.
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.BFILE_PROC";   
  ...
  * 
  */                                              
  public DatatypeTestBfileProc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestBfileProc started");  //DEBUG                  
    }                                                             
   
   
  /**
  * Method to set lob locator for  paramInParam
  * @param oracle.sql.BFILE lobInParam
  */
  public void setParamInParam(oracle.sql.BFILE lobInParam)
    {
  ...
  * @param oracle.sql.BFILE lobInOutParam
  */
  public void setParamInOutParam(oracle.sql.BFILE lobInOutParam)
    {
  ...
  * @throws NullPointerException if OUT_PARAM is null
  */
  public oracle.sql.BFILE getParamOutParamBfile() 
    {
    return (lobOutParam);
    }
  ...
  * @throws NullPointerException if IN_OUT_PARAM is null
  */
  public oracle.sql.BFILE getParamInOutParamBfile() 
    {
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    lobOutParam =  (oracle.sql.BFILE)theParameters.getParam(2);    
    if (lobOutParam != null && useByteArraysForLongsAndLOBS)
      { 
      byteArrayOutParam = objectLoader.unloadBfileIntoByteArray(lobOutParam);   
      }
    else if (lobOutParam != null && (! keepLobs))
      { 
      paramOutParam = objectLoader.unloadBfile(paramOutParam,lobOutParam);   
      }
    ...
    paramOutSeqno =  (java.math.BigDecimal)theParameters.getParam(3);
    ...
    lobInOutParam =  (oracle.sql.BFILE)theParameters.getParam(4);    
    if (lobInOutParam != null && useByteArraysForLongsAndLOBS)
      { 
      byteArrayInOutParam = objectLoader.unloadBfileIntoByteArray(lobInOutParam);   
      }
    else if (lobInOutParam != null && (! keepLobs))
      { 
      paramInOutParam = objectLoader.unloadBfile(paramInOutParam,lobInOutParam);   
      }
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    try  
      ...
      {           
      throw (new CSException(lobInParam + " could not be loaded:" + e.toString()));   
      }          
    // Bind parameter OUT_PARAM
    theLog.debug("binding output parameter paramOutParam to position 2" );
    theParameters.setOutParam(2,OracleTypes.BFILE);
    // Bind parameter OUT_SEQNO
    theLog.debug("binding output parameter paramOutSeqno to position 3" );
    theParameters.setOutParam(3,OracleTypes.NUMERIC);
    // Bind parameter IN_OUT_PARAM
    
    theLog.debug("binding input parameter paramInOutParam to position 4");
    try  
      {  
      theParameters.setParam(4,lobInOutParam);
      }   
    catch (CSException e)   
      {           
      throw (new CSException(paramInOutParam.getAbsolutePath() + " could not be loaded:" + e.toString()));   
      }          
    theLog.debug("binding output parameter paramInOutParam to position 4" );
    theParameters.setOutParam(4,OracleTypes.BFILE);
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN DATATYPE_TEST.BFILE_PROC(IN_PARAM =>  ?, OUT_PARAM =>  ?, OUT_SEQNO =>  ?, IN_OUT_PARAM =>  ?); END; "); // 1 0 characters
