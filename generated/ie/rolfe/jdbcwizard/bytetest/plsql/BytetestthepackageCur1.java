...
/** 
* BytetestthepackageCur1 - Access Procedure BYTETESTTHEPACKAGE.CUR1
* Generated by JDBCWizard 6.0.3145 build 3145 at 2025/11/14 10:21:20.577 EST
*/ 
public class BytetestthepackageCur1 extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  public static final String procName = "BYTETESTTHEPACKAGE.CUR1";   
                                                    
  public static final int PROC_TYPE = AbstractProcCall.THIS_USERS_OBJECT; 
   
  private StringBuffer procCall = null;
   
  public BytetestthepackageCur1 (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("BytetestthepackageCur1 started");  //DEBUG                  
    }                                                             
  ...
  public BytetestthepackageLobDatatypesTypAttrs[] getParamOutParamArray() throws CSException
    {
    if (paramOutParam == null)
      {
      return(null);
    ...
    return ((BytetestthepackageLobDatatypesTypAttrs[])BytetestthepackageLobDatatypesTyp.createBytetestthepackageLobDatatypesTypArrayFromRowSet(paramOutParam,theLog));
    }
  ...
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append(" \n");
      procCall.append("BYTETESTTHEPACKAGE.CUR1(out_param => out_param); \n");
