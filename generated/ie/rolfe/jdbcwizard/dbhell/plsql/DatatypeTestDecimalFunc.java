...
/** 
* DatatypeTestDecimalFunc - Access Procedure DATATYPE_TEST.DECIMAL_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:38.750 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestDecimalFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.DECIMAL_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestDecimalFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestDecimalFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.DECIMAL_FUNC( ?); END; "); // 1 0 characters
