...
/** 
* DatatypeTestCharFunc - Access Procedure DATATYPE_TEST.CHAR_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:38.250 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestCharFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.CHAR_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestCharFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestCharFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.CHAR_FUNC( ?); END; "); // 1 0 characters
