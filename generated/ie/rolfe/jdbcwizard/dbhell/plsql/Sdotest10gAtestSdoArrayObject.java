...
/** 
* Sdotest10gAtestSdoArrayObject - Access Procedure SDOTEST_10G.ATEST_SDO_ARRAY_OBJECT
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:45.7 EST
...
* @author rolfe.ie
*/ 
public class Sdotest10gAtestSdoArrayObject extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
   
  /**
  * Variable to store P_PARAM1
  */
  public TblArraySdoGeometryObj paramPParam1 = null;
   
  /**
  * Variable to store P_PARAM2
  */
  public TblArraySdoGeometryObj paramPParam2 = null;
  ...
  */                 
  public static final String procName = "SDOTEST_10G.ATEST_SDO_ARRAY_OBJECT";   
  ...
  * 
  */                                              
  public Sdotest10gAtestSdoArrayObject (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("Sdotest10gAtestSdoArrayObject started");  //DEBUG                  
    }                                                             
   
   
  /**
  * Method to set parameter P_PARAM1
  * @param TblArraySdoGeometryObj paramPParam1
  */
  public void setParamPParam1(TblArraySdoGeometryObj paramPParam1)
    {
  ...
  * @param TblArraySdoGeometryObj paramPParam2
  */
  public void setParamPParam2(TblArraySdoGeometryObj paramPParam2)
    {
  ...
  * @return TblArraySdoGeometryObj
  */
  public TblArraySdoGeometryObj getParamPParam1()
    {
    return(paramPParam1);
    }
  ...
  * @return TblArraySdoGeometryObj
  */
  public TblArraySdoGeometryObj getParamPParam2()
    {
    return(paramPParam2);
    }
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    paramPParam1 =  (TblArraySdoGeometryObj)theParameters.getParam(3);
    
    // Unload parameter P_PARAM2
    
    // Unload paramPParam2
    theLog.debug("Unloading parameter paramPParam2" );
    paramPParam2 =  (TblArraySdoGeometryObj)theParameters.getParam(4);
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    if (paramPParam1 == null)
      {  
      paramPParam1 = new TblArraySdoGeometryObj(theLog);
      }   
       
    // Create temporary LOBs for paramPParam1
    try
      {       
      TypeArraySdogeoms[] theArray = paramPParam1.getCurrentValues();
    ...
    if (paramPParam2 == null)
      {  
      paramPParam2 = new TblArraySdoGeometryObj(theLog);
      }   
       
    // Create temporary LOBs for paramPParam2
    try
      {       
      TypeArraySdogeoms[] theArray = paramPParam2.getCurrentValues();
      for (int i=0; i < theArray.length; i++)
        {
        if (theArray[i] != null)
          {
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append("p_param1 TBL_ARRAY_SDO_GEOMETRY_OBJ := ?; \n"); // 4
      procCall.append("p_param2 TBL_ARRAY_SDO_GEOMETRY_OBJ := ?; \n"); // 5
      procCall.append("BEGIN  \n"); // 6
      procCall.append(" \n"); // 7
      procCall.append("SDOTEST_10G.ATEST_SDO_ARRAY_OBJECT(p_param1 => p_param1,p_param2 => p_param2); \n"); // 8
      procCall.append("? := p_param1; \n"); // 9
      procCall.append("? := p_param2; \n"); // 10
      procCall.append("END; "); // 11 287 characters
