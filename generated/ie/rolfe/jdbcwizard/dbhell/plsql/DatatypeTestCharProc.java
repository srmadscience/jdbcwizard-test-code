...
/** 
* DatatypeTestCharProc - Access Procedure DATATYPE_TEST.CHAR_PROC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:38.278 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestCharProc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.CHAR_PROC";   
  ...
  * 
  */                                              
  public DatatypeTestCharProc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestCharProc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN DATATYPE_TEST.CHAR_PROC(IN_PARAM =>  ?, OUT_PARAM =>  ?, IN_OUT_PARAM =>  ?); END; "); // 1 0 characters
