...
/** 
* DatatypeTestIntegerFunc - Access Procedure DATATYPE_TEST.INTEGER_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:39.58 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestIntegerFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.INTEGER_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestIntegerFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestIntegerFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.INTEGER_FUNC( ?); END; "); // 1 0 characters
