...
/** 
* DatatypeTestLongRawFunc - Access Procedure DATATYPE_TEST.LONG_RAW_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:39.388 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestLongRawFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.LONG_RAW_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestLongRawFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestLongRawFunc started");  //DEBUG                  
    }                                                             
  ...
  */
  public java.io.File getFunctionResult() 
    {
  ...
  */
  public java.io.File getFunctionResultByteArray(java.io.File defaultValue) 
    {
    if (functionResult == null)
      {
      return(defaultValue);
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    try  
      { 
      Object functionResultObject = theParameters.getParam(1);
      if (functionResultObject == null)
        {
        // Do nothing - there is nothing to unload...
        }
      else if (functionResultObject instanceof String)
        {
        functionResult = objectLoader.unloadBinaryStream(functionResult,(String)theParameters.getParam(1),"LONG");
        }
      else if (functionResultObject instanceof java.io.InputStream)
        {
        if (useByteArraysForLongsAndLOBS)
          {
          byteArrayFunctionResult = objectLoader.unloadBinaryStreamIntoByteArray((java.io.InputStream)theParameters.getParam(1),"LONG");
          }
          else
          {
          functionResult = objectLoader.unloadBinaryStream(functionResult,(java.io.InputStream)theParameters.getParam(1),"LONG");
          }
        }
      else
        {
        throw (new CSException("functionResult: Unable to turn " + functionResultObject.getClass().getName() + " into a file"));
        }
      }                        
    catch (Exception e)   
      {                                 
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    theParameters.setOutParam(1,OracleTypes.LONGVARBINARY);
    ...
    try
      ...
      if (byteArrayInParam != null && useByteArraysForLongsAndLOBS)  
        {       
        theParameters.setParam(2,new java.io.ByteArrayInputStream(byteArrayInParam), byteArrayInParam.length,OracleTypes.LONGVARBINARY);
        }               
      else if (paramInParam != null)  
        {       
        theParameters.setParam(2,new java.io.BufferedInputStream(new java.io.FileInputStream(paramInParam),bufferSize),(int)paramInParam.length(),OracleTypes.LONGVARBINARY);
        }               
      else            
        {                 
      ...
      {
      throw new CSException("Unable to bind parameter 2: File " + paramInParam.getAbsolutePath() +" not found");
      }
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.LONG_RAW_FUNC( ?); END; "); // 1 0 characters
