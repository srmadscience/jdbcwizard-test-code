...
/** 
* DatatypeTestStringFunc - Access Procedure DATATYPE_TEST.STRING_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:40.556 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestStringFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.STRING_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestStringFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestStringFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.STRING_FUNC( ?); END; "); // 1 0 characters
