...
/** 
* DatatypeTestNaturalnFunc - Access Procedure DATATYPE_TEST.NATURALN_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:39.445 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestNaturalnFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.NATURALN_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestNaturalnFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestNaturalnFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    theParameters.setOutParam(1,OracleTypes.NUMBER);
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.NATURALN_FUNC( ?); END; "); // 1 0 characters
