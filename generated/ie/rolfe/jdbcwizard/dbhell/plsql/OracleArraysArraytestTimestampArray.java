...
/** 
* OracleArraysArraytestTimestampArray - Access Procedure ORACLE_ARRAYS.ARRAYTEST_TIMESTAMP_ARRAY
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:42.87 EST
...
* @author rolfe.ie
*/ 
public class OracleArraysArraytestTimestampArray extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
   
  /**
  * Variable to store P_PARAM1
  */
  public TblVarrayTimestamp paramPParam1 = null;
   
  /**
  * Variable to store P_PARAM2
  */
  public TblArrayTimestamp paramPParam2 = null;
   
  /**    
  * The name of the procedure or function we will access.
  * This name be actually refer to a synonym or somebody else's code  
  */                 
  public static final String procName = "ORACLE_ARRAYS.ARRAYTEST_TIMESTAMP_ARRAY";   
  ...
  * 
  */                                              
  public OracleArraysArraytestTimestampArray (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("OracleArraysArraytestTimestampArray started");  //DEBUG                  
    }                                                             
   
   
  /**
  * Method to set parameter P_PARAM1
  * @param TblVarrayTimestamp paramPParam1
  */
  public void setParamPParam1(TblVarrayTimestamp paramPParam1)
    {
  ...
  * @param TblArrayTimestamp paramPParam2
  */
  public void setParamPParam2(TblArrayTimestamp paramPParam2)
    {
  ...
  * @return TblVarrayTimestamp
  */
  public TblVarrayTimestamp getParamPParam1()
    {
    return(paramPParam1);
    }
  ...
  * @return TblArrayTimestamp
  */
  public TblArrayTimestamp getParamPParam2()
    {
    return(paramPParam2);
    }
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    paramPParam1 =  (TblVarrayTimestamp)theParameters.getParam(3);
    
    // Unload parameter P_PARAM2
    
    // Unload paramPParam2
    theLog.debug("Unloading parameter paramPParam2" );
    paramPParam2 =  (TblArrayTimestamp)theParameters.getParam(4);
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    if (paramPParam1 == null)
      {  
      paramPParam1 = new TblVarrayTimestamp(theLog);
      }   
       
    // Make sure P_PARAM2 is not null
    if (paramPParam2 == null)
      {  
      paramPParam2 = new TblArrayTimestamp(theLog);
      }   
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append("p_param1 TBL_VARRAY_TIMESTAMP := ?; \n"); // 4
      procCall.append("p_param2 TBL_ARRAY_TIMESTAMP := ?; \n"); // 5
      procCall.append("BEGIN  \n"); // 6
      procCall.append(" \n"); // 7
      procCall.append("ORACLE_ARRAYS.ARRAYTEST_TIMESTAMP_ARRAY(p_param1 => p_param1,p_param2 => p_param2); \n"); // 8
      procCall.append("? := p_param1; \n"); // 9
      procCall.append("? := p_param2; \n"); // 10
      procCall.append("END; "); // 11 279 characters
