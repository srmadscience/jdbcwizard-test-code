...
/** 
* DatatypeTestVarcharProc - Access Procedure DATATYPE_TEST.VARCHAR_PROC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:40.738 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestVarcharProc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.VARCHAR_PROC";   
  ...
  * 
  */                                              
  public DatatypeTestVarcharProc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestVarcharProc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN DATATYPE_TEST.VARCHAR_PROC(IN_PARAM =>  ?, OUT_PARAM =>  ?, IN_OUT_PARAM =>  ?); END; "); // 1 0 characters
