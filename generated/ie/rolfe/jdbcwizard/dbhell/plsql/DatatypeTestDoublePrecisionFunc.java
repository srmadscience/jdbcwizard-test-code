...
/** 
* DatatypeTestDoublePrecisionFunc - Access Procedure DATATYPE_TEST.DOUBLE_PRECISION_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:38.909 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestDoublePrecisionFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.DOUBLE_PRECISION_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestDoublePrecisionFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestDoublePrecisionFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.DOUBLE_PRECISION_FUNC( ?); END; "); // 1 0 characters
