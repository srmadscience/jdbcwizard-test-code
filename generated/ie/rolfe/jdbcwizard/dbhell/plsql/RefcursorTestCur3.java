...
/** 
* RefcursorTestCur3 - Access Procedure REFCURSOR_TEST.CUR3
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:44.930 EST
...
* @author rolfe.ie
*/ 
public class RefcursorTestCur3 extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "REFCURSOR_TEST.CUR3";   
  ...
  * 
  */                                              
  public RefcursorTestCur3 (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("RefcursorTestCur3 started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    try
      {
      functionResult = new com.orindasoft.pub.ReadOnlyRowSet((ResultSet)theParameters.getParam(1), getProcCallStatement(),maxRows, theLog,tempFileDir,keepFiles,tempFilePrefix,tempFileSuffix,keepLobs, useByteArraysForLongsAndLOBS);
      }
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append(" \n"); // 7
      procCall.append("functionResult := REFCURSOR_TEST.CUR3; \n"); // 8
      procCall.append("? := functionResult; \n"); // 9
      procCall.append("END; "); // 10 227 characters
