...
/** 
* DatatypeTestNumberFunc - Access Procedure DATATYPE_TEST.NUMBER_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:39.863 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestNumberFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.NUMBER_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestNumberFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestNumberFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.NUMBER_FUNC( ?); END; "); // 1 0 characters
