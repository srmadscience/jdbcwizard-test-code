...
/** 
* DatatypeTestBfileFunc - Access Procedure DATATYPE_TEST.BFILE_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:37.754 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestBfileFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */
  public oracle.sql.BFILE lobFunctionResult = null;
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.BFILE_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestBfileFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestBfileFunc started");  //DEBUG                  
    }                                                             
  ...
  * @throws NullPointerException if _function_result_1 is null
  */
  public oracle.sql.BFILE getFunctionResultBfile() 
    {
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    lobFunctionResult =  (oracle.sql.BFILE)theParameters.getParam(1);    
    if (lobFunctionResult != null && useByteArraysForLongsAndLOBS)
      { 
      byteArrayFunctionResult = objectLoader.unloadBfileIntoByteArray(lobFunctionResult);   
      }
    else if (lobFunctionResult != null && (! keepLobs))
      { 
      functionResult = objectLoader.unloadBfile(functionResult,lobFunctionResult);   
      }
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    theParameters.setOutParam(1,OracleTypes.BFILE);
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.BFILE_FUNC( ?); END; "); // 1 0 characters
