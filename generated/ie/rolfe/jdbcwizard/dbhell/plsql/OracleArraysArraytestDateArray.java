...
/** 
* OracleArraysArraytestDateArray - Access Procedure ORACLE_ARRAYS.ARRAYTEST_DATE_ARRAY
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:41.913 EST
...
* @author rolfe.ie
*/ 
public class OracleArraysArraytestDateArray extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
   
  /**
  * Variable to store P_PARAM1
  */
  public TblVarrayDate paramPParam1 = null;
   
  /**
  * Variable to store P_PARAM2
  */
  public TblArrayDate paramPParam2 = null;
   
  /**    
  * The name of the procedure or function we will access.
  * This name be actually refer to a synonym or somebody else's code  
  */                 
  public static final String procName = "ORACLE_ARRAYS.ARRAYTEST_DATE_ARRAY";   
  ...
  * 
  */                                              
  public OracleArraysArraytestDateArray (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("OracleArraysArraytestDateArray started");  //DEBUG                  
    }                                                             
   
   
  /**
  * Method to set parameter P_PARAM1
  * @param TblVarrayDate paramPParam1
  */
  public void setParamPParam1(TblVarrayDate paramPParam1)
    {
  ...
  * @param TblArrayDate paramPParam2
  */
  public void setParamPParam2(TblArrayDate paramPParam2)
    {
  ...
  * @return TblVarrayDate
  */
  public TblVarrayDate getParamPParam1()
    {
    return(paramPParam1);
    }
  ...
  * @return TblArrayDate
  */
  public TblArrayDate getParamPParam2()
    {
    return(paramPParam2);
    }
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    paramPParam1 =  (TblVarrayDate)theParameters.getParam(3);
    
    // Unload parameter P_PARAM2
    
    // Unload paramPParam2
    theLog.debug("Unloading parameter paramPParam2" );
    paramPParam2 =  (TblArrayDate)theParameters.getParam(4);
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    if (paramPParam1 == null)
      {  
      paramPParam1 = new TblVarrayDate(theLog);
      }   
       
    // Make sure P_PARAM2 is not null
    if (paramPParam2 == null)
      {  
      paramPParam2 = new TblArrayDate(theLog);
      }   
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append("p_param1 TBL_VARRAY_DATE := ?; \n"); // 4
      procCall.append("p_param2 TBL_ARRAY_DATE := ?; \n"); // 5
      procCall.append("BEGIN  \n"); // 6
      procCall.append(" \n"); // 7
      procCall.append("ORACLE_ARRAYS.ARRAYTEST_DATE_ARRAY(p_param1 => p_param1,p_param2 => p_param2); \n"); // 8
