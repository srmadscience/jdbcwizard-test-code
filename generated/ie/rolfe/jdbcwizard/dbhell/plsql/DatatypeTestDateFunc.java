...
/** 
* DatatypeTestDateFunc - Access Procedure DATATYPE_TEST.DATE_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:38.672 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestDateFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */
  public java.util.Date functionResult = null;
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.DATE_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestDateFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestDateFunc started");  //DEBUG                  
    }                                                             
  ...
  */
  public java.util.Date getFunctionResult()
    {
    ...
    return (new java.util.Date(functionResult.getTime()));
    }
  ...
  */
  public long getFunctionResultLong()
    {
    return (functionResult.getTime());
    }
  /**
  * Method to get _function_result_1
  * @return java.sql.Timestamp
  */
  public java.sql.Timestamp getFunctionResultTimestamp()
    {
    if (functionResult == null)
      {
      return(null);
    ...
    return (new java.sql.Timestamp(functionResult.getTime()));
    }
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    functionResult =  (java.util.Date)theParameters.getParam(1);
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.DATE_FUNC( ?); END; "); // 1 0 characters
