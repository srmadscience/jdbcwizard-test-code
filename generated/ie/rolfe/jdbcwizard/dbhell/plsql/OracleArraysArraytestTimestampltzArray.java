...
/** 
* OracleArraysArraytestTimestampltzArray - Access Procedure ORACLE_ARRAYS.ARRAYTEST_TIMESTAMPLTZ_ARRAY
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:42.31 EST
...
* @author rolfe.ie
*/ 
public class OracleArraysArraytestTimestampltzArray extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
   
  /**
  * Variable to store P_PARAM1
  */
  public TblVarrayTimestampltz paramPParam1 = null;
   
  /**
  * Variable to store P_PARAM2
  */
  public TblArrayTimestampltz paramPParam2 = null;
   
  /**    
  * The name of the procedure or function we will access.
  * This name be actually refer to a synonym or somebody else's code  
  */                 
  public static final String procName = "ORACLE_ARRAYS.ARRAYTEST_TIMESTAMPLTZ_ARRAY";   
  ...
  * 
  */                                              
  public OracleArraysArraytestTimestampltzArray (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("OracleArraysArraytestTimestampltzArray started");  //DEBUG                  
    }                                                             
   
   
  /**
  * Method to set parameter P_PARAM1
  * @param TblVarrayTimestampltz paramPParam1
  */
  public void setParamPParam1(TblVarrayTimestampltz paramPParam1)
    {
  ...
  * @param TblArrayTimestampltz paramPParam2
  */
  public void setParamPParam2(TblArrayTimestampltz paramPParam2)
    {
  ...
  * @return TblVarrayTimestampltz
  */
  public TblVarrayTimestampltz getParamPParam1()
    {
    return(paramPParam1);
    }
  ...
  * @return TblArrayTimestampltz
  */
  public TblArrayTimestampltz getParamPParam2()
    {
    return(paramPParam2);
    }
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    paramPParam1 =  (TblVarrayTimestampltz)theParameters.getParam(3);
    
    // Unload parameter P_PARAM2
    
    // Unload paramPParam2
    theLog.debug("Unloading parameter paramPParam2" );
    paramPParam2 =  (TblArrayTimestampltz)theParameters.getParam(4);
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    if (paramPParam1 == null)
      {  
      paramPParam1 = new TblVarrayTimestampltz(theLog);
      }   
       
    // Make sure P_PARAM2 is not null
    if (paramPParam2 == null)
      {  
      paramPParam2 = new TblArrayTimestampltz(theLog);
      }   
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append("p_param1 TBL_VARRAY_TIMESTAMPLTZ := ?; \n"); // 4
      procCall.append("p_param2 TBL_ARRAY_TIMESTAMPLTZ := ?; \n"); // 5
      procCall.append("BEGIN  \n"); // 6
      procCall.append(" \n"); // 7
      procCall.append("ORACLE_ARRAYS.ARRAYTEST_TIMESTAMPLTZ_ARRAY(p_param1 => p_param1,p_param2 => p_param2); \n"); // 8
      procCall.append("? := p_param1; \n"); // 9
      procCall.append("? := p_param2; \n"); // 10
      procCall.append("END; "); // 11 288 characters
