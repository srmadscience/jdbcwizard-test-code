...
/** 
* DatatypeTestPositiveFunc - Access Procedure DATATYPE_TEST.POSITIVE_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:40.220 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestPositiveFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.POSITIVE_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestPositiveFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestPositiveFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.POSITIVE_FUNC( ?); END; "); // 1 0 characters
