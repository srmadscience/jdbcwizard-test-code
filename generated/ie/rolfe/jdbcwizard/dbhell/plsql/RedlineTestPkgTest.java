...
/** 
* RedlineTestPkgTest - Access Procedure REDLINE_TEST_PKG.TEST
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:44.747 EST
...
* @author rolfe.ie
*/ 
public class RedlineTestPkgTest extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "REDLINE_TEST_PKG.TEST";   
  ...
  * 
  */                                              
  public RedlineTestPkgTest (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("RedlineTestPkgTest started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append("data := DBHELL.REDLINE_TEST(?,?); \n"); // 6
      procCall.append(" \n"); // 7
      procCall.append("REDLINE_TEST_PKG.TEST(data => data); \n"); // 8
      procCall.append("? := data.id; \n"); // 9
      procCall.append("? := data.text; \n"); // 10
      procCall.append("END; "); // 11 221 characters
