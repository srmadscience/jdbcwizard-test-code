...
/** 
* OracleArraysv8ArraytestRawArray - Access Procedure ORACLE_ARRAYSV8.ARRAYTEST_RAW_ARRAY
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:42.297 EST
...
* @author rolfe.ie
*/ 
public class OracleArraysv8ArraytestRawArray extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
   
  /**
  * Variable to store P_PARAM1
  */
  public TblVarrayRaw paramPParam1 = null;
   
  /**
  * Variable to store P_PARAM2
  */
  public TblArrayRaw paramPParam2 = null;
   
  /**    
  * The name of the procedure or function we will access.
  * This name be actually refer to a synonym or somebody else's code  
  */                 
  public static final String procName = "ORACLE_ARRAYSV8.ARRAYTEST_RAW_ARRAY";   
  ...
  * 
  */                                              
  public OracleArraysv8ArraytestRawArray (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("OracleArraysv8ArraytestRawArray started");  //DEBUG                  
    }                                                             
   
   
  /**
  * Method to set parameter P_PARAM1
  * @param TblVarrayRaw paramPParam1
  */
  public void setParamPParam1(TblVarrayRaw paramPParam1)
    {
  ...
  * @param TblArrayRaw paramPParam2
  */
  public void setParamPParam2(TblArrayRaw paramPParam2)
    {
  ...
  * @return TblVarrayRaw
  */
  public TblVarrayRaw getParamPParam1()
    {
    return(paramPParam1);
    }
  ...
  * @return TblArrayRaw
  */
  public TblArrayRaw getParamPParam2()
    {
    return(paramPParam2);
    }
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    paramPParam1 =  (TblVarrayRaw)theParameters.getParam(3);
    
    // Unload parameter P_PARAM2
    
    // Unload paramPParam2
    theLog.debug("Unloading parameter paramPParam2" );
    paramPParam2 =  (TblArrayRaw)theParameters.getParam(4);
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    if (paramPParam1 == null)
      {  
      paramPParam1 = new TblVarrayRaw(theLog);
      }   
       
    // Make sure P_PARAM2 is not null
    if (paramPParam2 == null)
      {  
      paramPParam2 = new TblArrayRaw(theLog);
      }   
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append("p_param1 TBL_VARRAY_RAW := ?; \n"); // 4
      procCall.append("p_param2 TBL_ARRAY_RAW := ?; \n"); // 5
      procCall.append("BEGIN  \n"); // 6
      procCall.append(" \n"); // 7
      procCall.append("ORACLE_ARRAYSV8.ARRAYTEST_RAW_ARRAY(p_param1 => p_param1,p_param2 => p_param2); \n"); // 8
      procCall.append("? := p_param1; \n"); // 9
      procCall.append("? := p_param2; \n"); // 10
      procCall.append("END; "); // 11 263 characters
