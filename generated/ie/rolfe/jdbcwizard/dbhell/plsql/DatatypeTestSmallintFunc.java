...
/** 
* DatatypeTestSmallintFunc - Access Procedure DATATYPE_TEST.SMALLINT_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:40.496 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestSmallintFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.SMALLINT_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestSmallintFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestSmallintFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.SMALLINT_FUNC( ?); END; "); // 1 0 characters
