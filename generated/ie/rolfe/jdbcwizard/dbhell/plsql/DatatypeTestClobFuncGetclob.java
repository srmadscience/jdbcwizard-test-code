...
/** 
* DatatypeTestClobFuncGetclob - Access Procedure DATATYPE_TEST.CLOB_FUNC_GETCLOB
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:38.351 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestClobFuncGetclob extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.CLOB_FUNC_GETCLOB";   
  ...
  * 
  */                                              
  public DatatypeTestClobFuncGetclob (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestClobFuncGetclob started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.CLOB_FUNC_GETCLOB( ?); END; "); // 1 0 characters
