...
/** 
* OracleArraysArraytestVarchar2Array - Access Procedure ORACLE_ARRAYS.ARRAYTEST_VARCHAR2_ARRAY
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:42.114 EST
...
* @author rolfe.ie
*/ 
public class OracleArraysArraytestVarchar2Array extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
   
  /**
  * Variable to store P_PARAM1
  */
  public TblVarrayVarchar2 paramPParam1 = null;
   
  /**
  * Variable to store P_PARAM2
  */
  public TblArrayVarchar2 paramPParam2 = null;
   
  /**    
  * The name of the procedure or function we will access.
  * This name be actually refer to a synonym or somebody else's code  
  */                 
  public static final String procName = "ORACLE_ARRAYS.ARRAYTEST_VARCHAR2_ARRAY";   
  ...
  * 
  */                                              
  public OracleArraysArraytestVarchar2Array (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("OracleArraysArraytestVarchar2Array started");  //DEBUG                  
    }                                                             
   
   
  /**
  * Method to set parameter P_PARAM1
  * @param TblVarrayVarchar2 paramPParam1
  */
  public void setParamPParam1(TblVarrayVarchar2 paramPParam1)
    {
  ...
  * @param TblArrayVarchar2 paramPParam2
  */
  public void setParamPParam2(TblArrayVarchar2 paramPParam2)
    {
  ...
  * @return TblVarrayVarchar2
  */
  public TblVarrayVarchar2 getParamPParam1()
    {
    return(paramPParam1);
    }
  ...
  * @return TblArrayVarchar2
  */
  public TblArrayVarchar2 getParamPParam2()
    {
    return(paramPParam2);
    }
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    paramPParam1 =  (TblVarrayVarchar2)theParameters.getParam(3);
    
    // Unload parameter P_PARAM2
    
    // Unload paramPParam2
    theLog.debug("Unloading parameter paramPParam2" );
    paramPParam2 =  (TblArrayVarchar2)theParameters.getParam(4);
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    if (paramPParam1 == null)
      {  
      paramPParam1 = new TblVarrayVarchar2(theLog);
      }   
       
    // Make sure P_PARAM2 is not null
    if (paramPParam2 == null)
      {  
      paramPParam2 = new TblArrayVarchar2(theLog);
      }   
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append("p_param1 TBL_VARRAY_VARCHAR2 := ?; \n"); // 4
      procCall.append("p_param2 TBL_ARRAY_VARCHAR2 := ?; \n"); // 5
      procCall.append("BEGIN  \n"); // 6
      procCall.append(" \n"); // 7
      procCall.append("ORACLE_ARRAYS.ARRAYTEST_VARCHAR2_ARRAY(p_param1 => p_param1,p_param2 => p_param2); \n"); // 8
      procCall.append("? := p_param1; \n"); // 9
      procCall.append("? := p_param2; \n"); // 10
      procCall.append("END; "); // 11 276 characters
