...
/** 
* DatatypeTestRowidProc - Access Procedure DATATYPE_TEST.ROWID_PROC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:40.409 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestRowidProc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
   
  /**
  * Variable to store IN_PARAM
  */
  public oracle.sql.ROWID paramInParam = null;
   
  /**
  * Variable to store OUT_PARAM
  */
  public oracle.sql.ROWID paramOutParam = null;
   
  /**
  * Variable to store IN_OUT_PARAM
  */
  public oracle.sql.ROWID paramInOutParam = null;
   
  /**    
  * The name of the procedure or function we will access.
  * This name be actually refer to a synonym or somebody else's code  
  */                 
  public static final String procName = "DATATYPE_TEST.ROWID_PROC";   
  ...
  * 
  */                                              
  public DatatypeTestRowidProc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestRowidProc started");  //DEBUG                  
    }                                                             
   
   
  /**
  * Method to set parameter IN_PARAM
  * @param oracle.sql.ROWID paramInParam
  */
  public void setParamInParam(oracle.sql.ROWID paramInParam)
    {
    if (paramInParam == null)
      ...
      {
      this.paramInParam = new oracle.sql.ROWID(paramInParam.getBytes());
      }
    }
  ...
  * @param oracle.sql.ROWID paramInOutParam
  */
  public void setParamInOutParam(oracle.sql.ROWID paramInOutParam)
    {
    if (paramInOutParam == null)
      ...
      {
      this.paramInOutParam = new oracle.sql.ROWID(paramInOutParam.getBytes());
      }
    }
  ...
  */
  public void setParamInOutParam(String paramInOutParam)
    {
    if (paramInOutParam == null)
      {
      this.paramInOutParam = null;
  ...
  */
  public String getParamOutParamString()
    ...
    return (new String(paramOutParam.getBytes()));
    }
  ...
  */
  public oracle.sql.ROWID getParamOutParamOracleSqlRowid()
    {
    if (paramOutParam == null)
      {
      return(null);
    ...
    return (new oracle.sql.ROWID(paramOutParam.getBytes()));
    }
  ...
  */
  public String getParamInOutParamString()
    ...
    return (new String(paramInOutParam.getBytes()));
    }
  ...
  * @return oracle.sql.ROWID
  */
  public oracle.sql.ROWID getParamInOutParamOracleSqlRowid()
    {
    if (paramInOutParam == null)
      {
      return(null);
    ...
    return (new oracle.sql.ROWID(paramInOutParam.getBytes()));
    }
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    paramOutParam =  (oracle.sql.ROWID)theParameters.getParam(2);
    
    // Unload parameter IN_OUT_PARAM
    
    // Unload paramInOutParam
    theLog.debug("Unloading parameter paramInOutParam" );
    paramInOutParam =  (oracle.sql.ROWID)theParameters.getParam(3);
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    theParameters.setOutParam(2,OracleTypes.ROWID);
    ...
    theParameters.setOutParam(3,OracleTypes.ROWID);
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN DATATYPE_TEST.ROWID_PROC(IN_PARAM =>  ?, OUT_PARAM =>  ?, IN_OUT_PARAM =>  ?); END; "); // 1 0 characters
