...
/** 
* DatatypeTestBooleanFunc - Access Procedure DATATYPE_TEST.BOOLEAN_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:38.121 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestBooleanFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.BOOLEAN_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestBooleanFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestBooleanFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append("  \n"); // 17
      procCall.append(" \n"); // 18
      procCall.append("functionResult := DATATYPE_TEST.BOOLEAN_FUNC(in_param => in_param); \n"); // 19
      procCall.append("  \n"); // 20
      ...
      procCall.append("END; "); // 30 668 characters
