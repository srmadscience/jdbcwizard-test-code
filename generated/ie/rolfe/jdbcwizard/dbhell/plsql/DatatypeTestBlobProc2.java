...
/** 
* DatatypeTestBlobProc2 - Access Procedure DATATYPE_TEST.BLOB_PROC_2
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:38.79 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestBlobProc2 extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */
  ...
  /**
  * Variable to store IN_SEQNO
  */
  public java.math.BigDecimal paramInSeqno = null;
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.BLOB_PROC_2";   
  ...
  * 
  */                                              
  public DatatypeTestBlobProc2 (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestBlobProc2 started");  //DEBUG                  
    }                                                             
   
   
  /**
  * Method to set parameter IN_SEQNO
  * @param Double paramInSeqno
  */
  public void setParamInSeqno(Double paramInSeqno)
    {
    if (paramInSeqno == null)
      {
      this.paramInSeqno = null;
      }
    else
      {
      this.paramInSeqno = new java.math.BigDecimal(paramInSeqno.doubleValue());
      }
    }
   
  /**
  * Method to set parameter IN_SEQNO
  * @param Float paramInSeqno
  */
  public void setParamInSeqno(Float paramInSeqno)
    {
    if (paramInSeqno == null)
      {
      this.paramInSeqno = null;
  ...
  /**
  * Method to set parameter IN_SEQNO
  * @param Long paramInSeqno
  */
  public void setParamInSeqno(Long paramInSeqno)
    {
    if (paramInSeqno == null)
      {
      this.paramInSeqno = null;
  ...
  /**
  * Method to set parameter IN_SEQNO
  * @param Integer paramInSeqno
  */
  public void setParamInSeqno(Integer paramInSeqno)
    {
    if (paramInSeqno == null)
      {
      this.paramInSeqno = null;
  ...
  /**
  * Method to set parameter IN_SEQNO
  * @param Short paramInSeqno
  */
  public void setParamInSeqno(Short paramInSeqno)
    {
    if (paramInSeqno == null)
      {
      this.paramInSeqno = null;
  ...
  /**
  * Method to set parameter IN_SEQNO
  * @param Byte paramInSeqno
  */
  public void setParamInSeqno(Byte paramInSeqno)
    {
    if (paramInSeqno == null)
      {
      this.paramInSeqno = null;
  ...
  */
  public void setParamInSeqno(double paramInSeqno) 
    {
    this.paramInSeqno = new java.math.BigDecimal(paramInSeqno);
    }
  ...
  */
  public void setParamInSeqno(float paramInSeqno) 
    {
    this.paramInSeqno = new java.math.BigDecimal((double)paramInSeqno);
    }
  ...
  */
  ...
  /**
  * Method to set parameter IN_SEQNO
  * @param int paramInSeqno
  */
  public void setParamInSeqno(int paramInSeqno) 
    {
    this.paramInSeqno = new java.math.BigDecimal((double)paramInSeqno);
    }
  ...
  */
  ...
  /**
  * Method to set parameter IN_SEQNO
  * @param java.math.BigDecimal paramInSeqno
  */
  public void setParamInSeqno(java.math.BigDecimal paramInSeqno)
    {
    if (paramInSeqno == null)
      {
      this.paramInSeqno = null;
  ...
  /**
  * Method to set parameter IN_SEQNO to null
  */
  public void setParamInSeqnoToNull()
    {
    this.paramInSeqno = null;
    }
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    // Bind parameter IN_SEQNO
    
    theLog.debug("binding input parameter paramInSeqno to position 2");
    theParameters.setParam(2,paramInSeqno);
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN DATATYPE_TEST.BLOB_PROC_2(OUT_PARAM =>  ?, IN_SEQNO =>  ?); END; "); // 1 0 characters
