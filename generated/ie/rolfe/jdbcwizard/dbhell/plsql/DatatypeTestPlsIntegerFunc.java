...
/** 
* DatatypeTestPlsIntegerFunc - Access Procedure DATATYPE_TEST.PLS_INTEGER_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:40.114 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestPlsIntegerFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.PLS_INTEGER_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestPlsIntegerFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestPlsIntegerFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.PLS_INTEGER_FUNC( ?); END; "); // 1 0 characters
