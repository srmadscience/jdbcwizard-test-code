...
/** 
* DatatypeTestLongFunc - Access Procedure DATATYPE_TEST.LONG_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:39.330 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestLongFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.LONG_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestLongFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestLongFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    theParameters.setOutParam(1,OracleTypes.LONGVARCHAR);
    ...
    try
      ...
      if (byteArrayInParam != null && useByteArraysForLongsAndLOBS)  
        {       
        theParameters.setParam(2,new java.io.ByteArrayInputStream(byteArrayInParam), byteArrayInParam.length,OracleTypes.LONGVARCHAR);
        }               
      else if (paramInParam != null)  
        {       
        theParameters.setParam(2,new java.io.BufferedInputStream(new java.io.FileInputStream(paramInParam),bufferSize),(int)paramInParam.length(),OracleTypes.LONGVARCHAR);
        }               
      else            
        {                 
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.LONG_FUNC( ?); END; "); // 1 0 characters
