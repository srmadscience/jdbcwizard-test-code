...
/** 
* DatatypeTestNaturalnProc - Access Procedure DATATYPE_TEST.NATURALN_PROC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:39.472 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestNaturalnProc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.NATURALN_PROC";   
  ...
  * 
  */                                              
  public DatatypeTestNaturalnProc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestNaturalnProc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    paramInOutParam =  (java.math.BigDecimal)theParameters.getParam(2);
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    theParameters.setParam(2,paramInOutParam);
    theLog.debug("binding output parameter paramInOutParam to position 2" );
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN DATATYPE_TEST.NATURALN_PROC(IN_PARAM =>  ?, IN_OUT_PARAM =>  ?); END; "); // 1 0 characters
