...
/** 
* DatatypeTestCharacterFunc - Access Procedure DATATYPE_TEST.CHARACTER_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:38.183 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestCharacterFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.CHARACTER_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestCharacterFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestCharacterFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    theParameters.setOutParam(1,OracleTypes.CHAR);
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.CHARACTER_FUNC( ?); END; "); // 1 0 characters
