...
/** 
* OracleArraysArraytestBfileArray - Access Procedure ORACLE_ARRAYS.ARRAYTEST_BFILE_ARRAY
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:41.828 EST
...
* @author rolfe.ie
*/ 
public class OracleArraysArraytestBfileArray extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
   
  /**
  * Variable to store P_PARAM1
  */
  public TblVarrayBfile paramPParam1 = null;
   
  /**
  * Variable to store P_PARAM2
  */
  public TblArrayBfile paramPParam2 = null;
   
  /**    
  * The name of the procedure or function we will access.
  * This name be actually refer to a synonym or somebody else's code  
  */                 
  public static final String procName = "ORACLE_ARRAYS.ARRAYTEST_BFILE_ARRAY";   
  ...
  * 
  */                                              
  public OracleArraysArraytestBfileArray (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("OracleArraysArraytestBfileArray started");  //DEBUG                  
    }                                                             
   
   
  /**
  * Method to set parameter P_PARAM1
  * @param TblVarrayBfile paramPParam1
  */
  public void setParamPParam1(TblVarrayBfile paramPParam1)
    {
  ...
  * @param TblArrayBfile paramPParam2
  */
  public void setParamPParam2(TblArrayBfile paramPParam2)
    {
  ...
  * @return TblVarrayBfile
  */
  public TblVarrayBfile getParamPParam1()
    {
    return(paramPParam1);
    }
  ...
  * @return TblArrayBfile
  */
  public TblArrayBfile getParamPParam2()
    {
    return(paramPParam2);
    }
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    paramPParam1 =  (TblVarrayBfile)theParameters.getParam(3);
    
    // Unload parameter P_PARAM2
    
    // Unload paramPParam2
    theLog.debug("Unloading parameter paramPParam2" );
    paramPParam2 =  (TblArrayBfile)theParameters.getParam(4);
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    if (paramPParam1 == null)
      {  
      paramPParam1 = new TblVarrayBfile(theLog);
      }   
       
    // Make sure P_PARAM2 is not null
    if (paramPParam2 == null)
      {  
      paramPParam2 = new TblArrayBfile(theLog);
      }   
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append("p_param1 TBL_VARRAY_BFILE := ?; \n"); // 4
      procCall.append("p_param2 TBL_ARRAY_BFILE := ?; \n"); // 5
      procCall.append("BEGIN  \n"); // 6
      procCall.append(" \n"); // 7
      procCall.append("ORACLE_ARRAYS.ARRAYTEST_BFILE_ARRAY(p_param1 => p_param1,p_param2 => p_param2); \n"); // 8
      procCall.append("? := p_param1; \n"); // 9
      procCall.append("? := p_param2; \n"); // 10
      procCall.append("END; "); // 11 267 characters
