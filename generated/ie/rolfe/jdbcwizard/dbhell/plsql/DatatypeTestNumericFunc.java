...
/** 
* DatatypeTestNumericFunc - Access Procedure DATATYPE_TEST.NUMERIC_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:39.916 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestNumericFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.NUMERIC_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestNumericFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestNumericFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.NUMERIC_FUNC( ?); END; "); // 1 0 characters
