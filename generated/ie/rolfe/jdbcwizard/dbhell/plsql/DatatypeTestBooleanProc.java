...
/** 
* DatatypeTestBooleanProc - Access Procedure DATATYPE_TEST.BOOLEAN_PROC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:38.150 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestBooleanProc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
   
  /**
  * Variable to store IN_PARAM
  */
  public Boolean paramInParam = null;
   
  /**
  * Variable to store OUT_PARAM
  */
  public Boolean paramOutParam = null;
   
  /**
  * Variable to store IN_OUT_PARAM
  */
  public Boolean paramInOutParam = null;
   
  /**    
  * The name of the procedure or function we will access.
  * This name be actually refer to a synonym or somebody else's code  
  */                 
  public static final String procName = "DATATYPE_TEST.BOOLEAN_PROC";   
  ...
  * 
  */                                              
  public DatatypeTestBooleanProc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestBooleanProc started");  //DEBUG                  
    }                                                             
   
   
  /**
  * Method to set parameter IN_PARAM
  * @param Boolean paramInParam
  */
  public void setParamInParam(Boolean paramInParam)
    {
    if (paramInParam == null)
      ...
      {
      this.paramInParam = new Boolean(paramInParam.booleanValue());
      }
    }
  ...
  */
  public void setParamInParam(boolean paramInParam) 
    {
    this.paramInParam = new Boolean(paramInParam);
    }
  ...
  * @param Boolean paramInOutParam
  */
  public void setParamInOutParam(Boolean paramInOutParam)
    {
    if (paramInOutParam == null)
      ...
      {
      this.paramInOutParam = new Boolean(paramInOutParam.booleanValue());
      }
    }
  ...
  */
  public void setParamInOutParam(boolean paramInOutParam) 
    {
    this.paramInOutParam = new Boolean(paramInOutParam);
    }
  ...
  * @return Boolean
  */
  public Boolean getParamOutParamBooleanObj()
    {
    ...
    return (new Boolean(paramOutParam.booleanValue()));
    }
  ...
  */
  public boolean getParamOutParamBoolean() 
    {
    return (paramOutParam.booleanValue());
    }
  ...
  */
  public boolean getParamOutParamBoolean(boolean defaultValue) 
    {
    if (paramOutParam == null)
      {
      return(defaultValue);
  ...
  * @return Boolean
  */
  public Boolean getParamInOutParamBooleanObj()
    {
    if (paramInOutParam == null)
      {
      return(null);
    ...
    return (new Boolean(paramInOutParam.booleanValue()));
    }
  ...
  */
  public boolean getParamInOutParamBoolean() 
    {
    return (paramInOutParam.booleanValue());
    }
  ...
  * @since JDBCWizard V5.0.2293
  */
  public boolean getParamInOutParamBoolean(boolean defaultValue) 
    {
    if (paramInOutParam == null)
      {
      return(defaultValue);
  ...
  */                                              
  protected void getStatementResults()  throws CSException 
    ...
    if (   theParameters.getParam(3) == null 
      ...
      {
      paramOutParam = new Boolean(false);
      }
    else 
      {
      paramOutParam = new Boolean(true);
      }
    ...
    // Booleans come back from the DB as int and have to be converted
    if (   theParameters.getParam(4) == null 
        || ((java.math.BigDecimal)theParameters.getParam(4)).intValue() == 0)
      {
      paramInOutParam = null;
      }
    else if (((java.math.BigDecimal)theParameters.getParam(4)).intValue() == -1)
      {
      paramInOutParam = new Boolean(false);
      }
    else 
      {
      paramInOutParam = new Boolean(true);
      }
  ...
  */                                              
  protected void bindParams() throws CSException 
    ...
    theParameters.setOutParam(4,OracleTypes.NUMBER);
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append("in_param BOOLEAN := null; \n"); // 4
      procCall.append("IN_PARAM_SN SIGNTYPE := ?; \n"); // 5
      procCall.append("out_param BOOLEAN := null; \n"); // 6
      procCall.append("OUT_PARAM_SN SIGNTYPE := null; \n"); // 7
      procCall.append("in_out_param BOOLEAN := null; \n"); // 8
      procCall.append("IN_OUT_PARAM_SN SIGNTYPE := ?; \n"); // 9
      procCall.append("BEGIN  \n"); // 10
      procCall.append("  \n"); // 11
      procCall.append("IF (IN_PARAM_SN IS NULL OR IN_PARAM_SN = 0) THEN  \n"); // 12
      procCall.append("  in_param := null;  \n"); // 13
      procCall.append("ELSIF IN_PARAM_SN = -1 THEN  \n"); // 14
      procCall.append("  in_param := FALSE;  \n"); // 15
      procCall.append("ELSIF IN_PARAM_SN = 1 THEN  \n"); // 16
      procCall.append("  in_param := TRUE;  \n"); // 17
      procCall.append("END IF;  \n"); // 18
      procCall.append("  \n"); // 19
      procCall.append("  \n"); // 20
      procCall.append("IF (IN_OUT_PARAM_SN IS NULL OR IN_OUT_PARAM_SN = 0) THEN  \n"); // 21
      procCall.append("  in_out_param := null;  \n"); // 22
      procCall.append("ELSIF IN_OUT_PARAM_SN = -1 THEN  \n"); // 23
      procCall.append("  in_out_param := FALSE;  \n"); // 24
      procCall.append("ELSIF IN_OUT_PARAM_SN = 1 THEN  \n"); // 25
      procCall.append("  in_out_param := TRUE;  \n"); // 26
      procCall.append("END IF;  \n"); // 27
      procCall.append("  \n"); // 28
      procCall.append(" \n"); // 29
      procCall.append("DATATYPE_TEST.BOOLEAN_PROC(in_param => in_param,out_param => out_param,in_out_param => in_out_param); \n"); // 30
      procCall.append("  \n"); // 31
      procCall.append("IF out_param IS NULL THEN  \n"); // 32
      procCall.append("  OUT_PARAM_SN := 0;  \n"); // 33
      procCall.append("ELSIF out_param = FALSE THEN  \n"); // 34
      procCall.append("  OUT_PARAM_SN := -1;  \n"); // 35
      procCall.append("ELSIF out_param = TRUE THEN  \n"); // 36
      procCall.append("  OUT_PARAM_SN := 1;  \n"); // 37
      procCall.append("END IF;  \n"); // 38
      procCall.append("  \n"); // 39
      procCall.append("  \n"); // 40
      procCall.append("IF in_out_param IS NULL THEN  \n"); // 41
      procCall.append("  IN_OUT_PARAM_SN := 0;  \n"); // 42
      procCall.append("ELSIF in_out_param = FALSE THEN  \n"); // 43
      procCall.append("  IN_OUT_PARAM_SN := -1;  \n"); // 44
      procCall.append("ELSIF in_out_param = TRUE THEN  \n"); // 45
      procCall.append("  IN_OUT_PARAM_SN := 1;  \n"); // 46
      procCall.append("END IF;  \n"); // 47
      procCall.append("  \n"); // 48
      procCall.append("? := OUT_PARAM_SN; \n"); // 49
      procCall.append("? := IN_OUT_PARAM_SN; \n"); // 50
      procCall.append("END; "); // 51 1115 characters
