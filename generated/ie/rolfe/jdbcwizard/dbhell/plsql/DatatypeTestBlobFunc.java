...
/** 
* DatatypeTestBlobFunc - Access Procedure DATATYPE_TEST.BLOB_FUNC
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:05:37.895 EST
...
* @author rolfe.ie
*/ 
public class DatatypeTestBlobFunc extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  public static final String procName = "DATATYPE_TEST.BLOB_FUNC";   
  ...
  * 
  */                                              
  public DatatypeTestBlobFunc (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("DatatypeTestBlobFunc started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      {                                                              
      procCall = new StringBuffer("BEGIN ? := DATATYPE_TEST.BLOB_FUNC( ?); END; "); // 1 0 characters
