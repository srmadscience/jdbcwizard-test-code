...
/** 
* Manager Class for SynuserAllNormalDatatypes9iRow
* 
...
* @author rolfe.ie
*/ 
public class SynuserAllNormalDatatypes9iMgr extends AbstractTableMgr implements OracleResourceUser, StatsInterface 
{ 
  /**                                             
  ...
  * 
  */                                              
  public SynuserAllNormalDatatypes9iMgr(Connection theConnection, LogInterface theLog) 
    { 
    super(theConnection, theLog);
    theLog.debug("SynuserAllNormalDatatypes9iMgr - Started");
  ...
  /**                                             
  * Validate a SynuserAllNormalDatatypes9iRow
  * @param SynuserAllNormalDatatypes9iRow theRow The row to be validated
  ...
  * 
  */                                              
  public void rowValidate( SynuserAllNormalDatatypes9iRow theRow) throws CSColumnException 
    { 
    ...
    if (theRow.rowName != null && theRow.rowName.length() > 4000 )
      {
      throw new CSColumnException("SYNUSER.ALL_NORMAL_DATATYPES_9I","NAME",CSColumnException.COLUMN_LENGTH_EXCEEDED,theRow.rowName,true,4000,0,"SYNUSER.ALL_NORMAL_DATATYPES_9I.NAME is too big");
      }
      
    // Column rowAURowid can not be more than 4000 characters
    if (theRow.rowAURowid != null && theRow.rowAURowid.length() > 4000 )
      {
      throw new CSColumnException("SYNUSER.ALL_NORMAL_DATATYPES_9I","A_U_ROWID",CSColumnException.COLUMN_LENGTH_EXCEEDED,theRow.rowAURowid,true,4000,0,"SYNUSER.ALL_NORMAL_DATATYPES_9I.A_U_ROWID is too big");
      }
      
    } 
    
/**
* Create a single SynuserAllNormalDatatypes9iRow from a com.orindasoft.pub.ReadOnlyRowSet
...
**/
public SynuserAllNormalDatatypes9iRow processOneSynuserAllNormalDatatypes9iRow(com.orindasoft.pub.ReadOnlyRowSet theRowSet) throws CSException
  {
  SynuserAllNormalDatatypes9iRow new_record = null;

  if (theRowSet.size() > 0)
    {
    new_record = new SynuserAllNormalDatatypes9iRow();
    theRowSet.first();
...
/**
* Create an arbitrary number of SynuserAllNormalDatatypes9iRow from a com.orindasoft.pub.ReadOnlyRowSet
* @param com.orindasoft.pub.ReadOnlyRowSet theRowSet
* @return SynuserAllNormalDatatypes9iRow[]
**/
public SynuserAllNormalDatatypes9iRow[] processManySynuserAllNormalDatatypes9iRows(com.orindasoft.pub.ReadOnlyRowSet theRowSet, int howMany) throws CSException
  {
  ...
  SynuserAllNormalDatatypes9iRow[] new_rows = null;
  SynuserAllNormalDatatypes9iRow new_record = null;

  // Only initialize array if ReadOnlyRowSet has data...
  if (size > 0)
    {
    new_rows =  new SynuserAllNormalDatatypes9iRow[size];
    }
  ...
  */ 
  ...
  public boolean releaseResources() 
    ...
    theLog.debug("SynuserAllNormalDatatypes9iMgr - Attempting to release connection");
    try 
      { 
      } 
    catch (Exception e) 
    ...
    theConnection = null; 
    incReleaseCount(); 
    theLog.debug("SynuserAllNormalDatatypes9iMgr- Finished releasing connection");
  ...
  */ 
  ...
  public boolean setConnection(Connection theConnection) 
    ...
    theLog.debug("SynuserAllNormalDatatypes9iMgr - Attempting to set connection");
    try 
      { 
