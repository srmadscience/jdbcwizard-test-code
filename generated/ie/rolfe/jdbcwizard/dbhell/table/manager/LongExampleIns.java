...
* LongExampleIns.TSQ
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:07:12.14 EST
...
* 
* <p>
* <p>File Name LongExampleIns
* <p>This class runs the SQL statement below:
* <code><pre> 
* -------------------------------------------------------------
* INSERT INTO LONG_EXAMPLE
* (NAME
* ,LONGDATA)
* VALUES
* ( ? /* Name String   
...
* @author rolfe.ie
*/ 
public class LongExampleIns extends AbstractSqlStatement implements OracleResourceUser, StatsInterface 
{
  ...
  * Sql statement text
  */                 
  private static final String SQLTEXT = "INSERT INTO LONG_EXAMPLE \n" // 1
                   +"(NAME \n" // 2
                   +",LONGDATA) \n" // 3
                   +"VALUES \n" // 4
                   +"( ? /* Name String */ \n" // 5
                   +", ? /* Longdata LONG */ ) "; // 6 66 characters
  ...
  * 
  */                                              
  public LongExampleIns (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("LongExampleIns started");  //DEBUG                  
    }                                                             
  ...
  */                                              
  protected void bindParams() throws CSException 
    {                                                                   
    theLog.debug("LongExampleIns - Binding Parameters"); //DEBUG
