...
* BfileExampleIns.TSQ
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:07:14.949 EST
...
* 
* <p>
* <p>File Name BfileExampleIns
* <p>This class runs the SQL statement below:
* <code><pre> 
* -------------------------------------------------------------
* INSERT INTO BFILE_EXAMPLE
* (NAME
* ,BFILEDATA)
* VALUES
* ( ? /* Name String   
...
public class BfileExampleIns extends AbstractSqlStatement implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  private static final String SQLTEXT = "INSERT INTO BFILE_EXAMPLE \n" // 1
                   ...
                   +"VALUES \n" // 4
                   +"( ? /* Name String */ \n" // 5
                   +", ? /* Bfiledata BFILE */ ) "; // 6 68 characters
