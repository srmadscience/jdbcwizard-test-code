...
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:07:03.801 EST
...
* 
* <p>
* <p>File Name LongrawExampleIns
* <p>This class runs the SQL statement below:
* <code><pre> 
* -------------------------------------------------------------
* INSERT INTO LONGRAW_EXAMPLE
* (NAME
* ,GIFDATA)
* VALUES
* ( ? /* Name String   
...
public class LongrawExampleIns extends AbstractSqlStatement implements OracleResourceUser, StatsInterface 
{
  ...
  */                 
  private static final String SQLTEXT = "INSERT INTO LONGRAW_EXAMPLE \n" // 1
                   ...
                   +"VALUES \n" // 4
                   +"( ? /* Name String */ \n" // 5
                   +", ? /* Gifdata LONG RAW */ ) "; // 6 68 characters
