...
/** 
* LongrawExampleUpd.TSQ
* 
* <p>Generated by JDBCWizard build 3145 at 2025/11/14 10:07:23.114 EST
...
* 
* <p>
* <p>File Name LongrawExampleUpd
* <p>This class runs the SQL statement below:
* <code><pre> 
* -------------------------------------------------------------
* UPDATE LONGRAW_EXAMPLE
* SET NAME =  ? /* Name String   
*   , GIFDATA =  ? /* Gifdata LONG RAW   
* WHERE  NAME = ? /* Name String   
* -------------------------------------------------------------
* </pre></code> 
* @author rolfe.ie
*/ 
public class LongrawExampleUpd extends AbstractSqlStatement implements OracleResourceUser, StatsInterface 
{
  
  /**
  * Variable to store desired filename for ParamGifdata
  */
  public String filenameParamgifdata = null;
  
  /**
  * Variable to store byte array for ParamGifdata
  */
  ...
  * Sql statement text
  */                 
  private static final String SQLTEXT = "UPDATE LONGRAW_EXAMPLE \n" // 1
                   +"SET NAME =  ? /* Name String */ \n" // 2
                   +"  , GIFDATA =  ? /* Gifdata LONG RAW */ \n" // 3
                   +"WHERE  NAME = ? /* Name String */ "; // 4 92 characters
  ...
  * 
  */                                              
  public LongrawExampleUpd (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("LongrawExampleUpd started");  //DEBUG                  
    }                                                             
  ...
  * @param java.io.File ParamGifdata
  */
  ...
  */                                              
  protected void bindParams() throws CSException 
    {                                                                   
    theLog.debug("LongrawExampleUpd - Binding Parameters"); //DEBUG
