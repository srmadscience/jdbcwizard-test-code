...
/** 
* PlsqlIndexbyTablesProc03 - Access Procedure PLSQL_INDEXBY_TABLES.PROC_03
* Generated by JDBCWizard 6.0.3145 build 3145 at 2025/11/14 10:13:49.866 EST
*/ 
public class PlsqlIndexbyTablesProc03 extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  public static final String procName = "PLSQL_INDEXBY_TABLES.PROC_03";   
                                                    
  public static final int PROC_TYPE = AbstractProcCall.THIS_USERS_OBJECT; 
   
  private StringBuffer procCall = null;
   
  public PlsqlIndexbyTablesProc03 (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("PlsqlIndexbyTablesProc03 started");  //DEBUG                  
    }                                                             
  ...
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append("END LOOP; \n");
      procCall.append(" \n");
      procCall.append("PLSQL_INDEXBY_TABLES.PROC_03(p1 => p1,p2 => p2,p3 => p3,status => status); \n");
      procCall.append("  \n");
