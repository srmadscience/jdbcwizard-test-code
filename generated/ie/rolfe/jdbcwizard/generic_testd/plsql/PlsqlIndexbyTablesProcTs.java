...
/** 
* PlsqlIndexbyTablesProcTs - Access Procedure PLSQL_INDEXBY_TABLES.PROC_TS
* Generated by JDBCWizard 6.0.3145 build 3145 at 2025/11/14 10:13:51.640 EST
*/ 
public class PlsqlIndexbyTablesProcTs extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  public static final String procName = "PLSQL_INDEXBY_TABLES.PROC_TS";   
                                                    
  public static final int PROC_TYPE = AbstractProcCall.THIS_USERS_OBJECT; 
   
  private StringBuffer procCall = null;
   
  public PlsqlIndexbyTablesProcTs (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("PlsqlIndexbyTablesProcTs started");  //DEBUG                  
    }                                                             
  ...
  protected void bindParams() throws CSException 
    ...
    try  
      {  
      paramP1.setDataType(oracle.jdbc.OracleTypes.TIMESTAMP);
      paramP1.setElementMaxLength(28);
    ...
    try  
      {  
      paramP2.setDataType(oracle.jdbc.OracleTypes.TIMESTAMP);
      paramP2.setElementMaxLength(28);
    ...
    try  
      {  
      paramP3.setDataType(oracle.jdbc.OracleTypes.TIMESTAMP);
      paramP3.setElementMaxLength(28);
  ...
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append("TYPE P1_t IS TABLE OF VARCHAR2(30) INDEX BY BINARY_INTEGER; \n");
      procCall.append("P1_v P1_t; \n");
      procCall.append("p1 PLSQL_INDEXBY_TABLES.INDEXBYTABTIMESTAMP; \n");
      procCall.append("TYPE P2_t IS TABLE OF VARCHAR2(30) INDEX BY BINARY_INTEGER; \n");
      procCall.append("P2_v P2_t; \n");
      procCall.append("p2 PLSQL_INDEXBY_TABLES.INDEXBYTABTIMESTAMP; \n");
      procCall.append("TYPE P3_t IS TABLE OF VARCHAR2(30) INDEX BY BINARY_INTEGER; \n");
      procCall.append("P3_v P3_t; \n");
      procCall.append("p3 PLSQL_INDEXBY_TABLES.INDEXBYTABTIMESTAMP; \n");
      ...
      procCall.append(" p1(i) := TO_TIMESTAMP(P1_v(i),'yyyy-mm-dd hh24:mi:ss.ff8'); \n");
      procCall.append("END LOOP; \n");
      procCall.append("  \n");
      procCall.append("FOR i IN P2_v.FIRST..P2_v.LAST LOOP \n");
      procCall.append(" p2(i) := TO_TIMESTAMP(P2_v(i),'yyyy-mm-dd hh24:mi:ss.ff8'); \n");
      procCall.append("END LOOP; \n");
      procCall.append(" \n");
      procCall.append("PLSQL_INDEXBY_TABLES.PROC_TS(p1 => p1,p2 => p2,p3 => p3,status => status); \n");
      procCall.append("  \n");
      procCall.append("P2_v.DELETE; \n");
      procCall.append("FOR i IN p2.FIRST..p2.LAST LOOP \n");
      procCall.append(" IF p2.exists(i) THEN P2_v(i) := TO_CHAR(p2(i),'yyyy-mm-dd hh24:mi:ss.ff8'); END IF; \n");
      procCall.append("END LOOP; \n");
      procCall.append("  \n");
      procCall.append("FOR i IN p3.FIRST..p3.LAST LOOP \n");
      procCall.append(" IF p3.exists(i) THEN P3_v(i) := TO_CHAR(p3(i),'yyyy-mm-dd hh24:mi:ss.ff8'); END IF; \n");
      procCall.append("END LOOP; \n");
      procCall.append("  \n");
