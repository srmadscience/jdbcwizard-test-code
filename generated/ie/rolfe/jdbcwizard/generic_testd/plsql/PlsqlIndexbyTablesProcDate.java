...
/** 
* PlsqlIndexbyTablesProcDate - Access Procedure PLSQL_INDEXBY_TABLES.PROC_DATE
* Generated by JDBCWizard 6.0.3145 build 3145 at 2025/11/14 10:13:50.468 EST
*/ 
public class PlsqlIndexbyTablesProcDate extends AbstractProcCall implements OracleResourceUser, StatsInterface 
{
  ...
  public static final String procName = "PLSQL_INDEXBY_TABLES.PROC_DATE";   
                                                    
  public static final int PROC_TYPE = AbstractProcCall.THIS_USERS_OBJECT; 
   
  private StringBuffer procCall = null;
   
  public PlsqlIndexbyTablesProcDate (Connection theConnection, LogInterface theLog) 
    {                                                             
    super(theConnection, theLog);                                 
    theLog.debug("PlsqlIndexbyTablesProcDate started");  //DEBUG                  
    }                                                             
  ...
  protected void bindParams() throws CSException 
    ...
    try  
      {  
      paramP1.setDataType(oracle.jdbc.OracleTypes.DATE);
    ...
    try  
      {  
      paramP2.setDataType(oracle.jdbc.OracleTypes.DATE);
    ...
    try  
      {  
      paramP3.setDataType(oracle.jdbc.OracleTypes.DATE);
  ...
  public String getProcCallStatement()                                             
    ...
    if (procCall == null)
      ...
      procCall.append(" p1(i) := TO_DATE(P1_v(i),'yyyy-mm-dd hh24:mi:ss'); \n");
      procCall.append("END LOOP; \n");
      procCall.append("  \n");
      procCall.append("FOR i IN P2_v.FIRST..P2_v.LAST LOOP \n");
      procCall.append(" p2(i) := TO_DATE(P2_v(i),'yyyy-mm-dd hh24:mi:ss'); \n");
      procCall.append("END LOOP; \n");
      procCall.append(" \n");
      procCall.append("PLSQL_INDEXBY_TABLES.PROC_DATE(p1 => p1,p2 => p2,p3 => p3,status => status); \n");
      procCall.append("  \n");
      procCall.append("P2_v.DELETE; \n");
      procCall.append("FOR i IN p2.FIRST..p2.LAST LOOP \n");
      procCall.append(" IF p2.exists(i) THEN P2_v(i) := TO_CHAR(p2(i),'yyyy-mm-dd hh24:mi:ss'); END IF; \n");
      procCall.append("END LOOP; \n");
      procCall.append("  \n");
      procCall.append("FOR i IN p3.FIRST..p3.LAST LOOP \n");
      procCall.append(" IF p3.exists(i) THEN P3_v(i) := TO_CHAR(p3(i),'yyyy-mm-dd hh24:mi:ss'); END IF; \n");
      procCall.append("END LOOP; \n");
      procCall.append("  \n");
